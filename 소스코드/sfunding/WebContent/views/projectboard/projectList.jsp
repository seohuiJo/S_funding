...
<body id="page-top">
        ...
        <div class="row">
            ...
            <div class="dropdown categorypage">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="/projectvideo">영화</a>
    ...
    <!-- Portfolio Grid 사진, 컨텐츠-->
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase" style="text-align: left;">모두의 스펀딩</h2>
            </div>
            <br>
            <div class="row">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption" style="height:250px;">
                            <div class="portfolio-caption-heading" style="text-align: left;">
                            	<a href="/projectSelect?projectNo=${project.projectNo }" style="color:black;text-decoration:none;">${project.projectTitle}</a>
                            </div><br>
