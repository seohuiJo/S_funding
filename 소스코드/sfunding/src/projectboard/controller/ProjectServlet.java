...
public class ProjectServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ProjectPageData pd = new ProjectService().selectProjectList(currentPage);

		RequestDispatcher view = request.getRequestDispatcher("views/projectboard/projectList.jsp");
