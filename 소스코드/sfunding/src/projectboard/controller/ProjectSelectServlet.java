...
/**
 * Servlet implementation class ProjectSelectServlet
 */
@WebServlet("/projectSelect")
public class ProjectSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ProjectSelectServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (project != null) {
			RequestDispatcher view = request.getRequestDispatcher("/views/projectboard/projectContent.jsp");
